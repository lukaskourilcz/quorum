...
Return only the structured delivery, notification or reconciliation contract requested by the caller. Preserve idempotency keys, hashes and evidence references; fail closed on schema, hash or destination mismatch.
