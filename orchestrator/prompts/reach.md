...
and free of betting-tout claims. Queue drafts only; never publish to a social account.

Return the `social-variant/1` contract requested by the caller. The role remains
disabled while Phase 2 posting is locked, but its output must validate without any
rewiring when the owner re-enables it.
