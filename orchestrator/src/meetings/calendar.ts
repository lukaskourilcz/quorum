...
function recordKind(record: MeetingRecord): CalendarFeed["slots"][number]["kind"] | null {
  if (record.kind === "cu-edition" || record.kind === "cu-product" || record.kind === "tt-marketing" || record.kind === "gv-brief" || record.kind === "incubator-scan" || record.kind === "incubator-synthesis" || record.kind === "mma-intake" || record.kind === "mma-analysis" || record.kind === "mag-editorial" || record.kind === "mag-desk" || record.kind === "studio") return record.kind;
...
function recordReference(record: MeetingRecord): string {
  ...
  if (record.kind === "tt-marketing" || record.kind === "gv-brief" || record.kind === "incubator-scan" || record.kind === "incubator-synthesis" || record.kind === "mma-intake" || record.kind === "mma-analysis" || record.kind === "mag-editorial" || record.kind === "mag-desk" || record.kind === "studio") {
