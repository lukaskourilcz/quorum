...
const CommonFields = {
  ...
  date: DateSchema,
  phase: z.enum(["founding", "am", "pm", "morning", "afternoon", "night", "cu-edition", "cu-product", "tt-marketing", "gv-brief", "ms-daily", "bh-desk", "ts-desk", "incubator-scan", "incubator-synthesis", "mma-intake", "mma-analysis", "mag-editorial", "mag-desk", "studio"]),
  episode: openObject({
...
const NamedVentureMeetingSchema = openObject({
  ...CommonFields,
  kind: z.enum(["cu-edition", "cu-product", "tt-marketing", "gv-brief", "ms-daily", "bh-desk", "ts-desk", "incubator-scan", "incubator-synthesis", "mma-intake", "mma-analysis", "mag-editorial", "mag-desk", "studio"]),
