...
export const KvorumRecommendationStatusSchema = z.enum([
  "draft",
  "approved",
  "posted",
  "archived",
...
export const KvorumRecommendationSchema = z.strictObject({
...
export type KvorumRecommendation = z.infer<typeof KvorumRecommendationSchema>;
