...
export const CalendarFeedSchema = openObject({
  ...
  slots: z.array(openObject({
    ...
    kind: z.enum(["venture-morning", "venture-afternoon", "venture-night", "cu-edition", "cu-product", "tt-marketing", "gv-brief", "incubator-scan", "incubator-synthesis", "mma-intake", "mma-analysis", "mag-editorial", "mag-desk", "article-am", "article-pm", "studio"]),
