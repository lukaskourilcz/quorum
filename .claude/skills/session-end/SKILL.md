---
name: session-end
description: Before ending a session, update the owner document with owner-needed items and finished tasks, keeping the shared marker format.
---
...
1. Update the owner document — `docs/NEEDED.md` here, `NEEDED.md` in the magazines:
   tick off (`- [x]`) anything finished this session, and add
