---
name: session-start
description: At the start of a session, scan the owner document for [owner:ai] tasks an agent can now complete and surface them.
---
...
1. Read the owner document — `docs/NEEDED.md` in this repository, `NEEDED.md` in the
   magazines — and find every open task marked `[owner:ai]` — work an agent
