...
Vendored and mirrored byte-for-byte into `.agents/skills/content-strategy/`. The sole local
adaptation replaces three links to upstream integration guides, which are not included in this
subset, with an explicit official-documentation and approval boundary. Re-vendor from upstream rather than hand-editing; edit both copies in the same
