...
every dependency and never grant content, spend, publishing or deployment authority. The morning
day checkpoint owns Operations materialization; the protected Admin refresh records a request
...
protected Admin reader share one rule: an issue state is evidence, never completion by itself.
