...
- Source: https://github.com/coreyhaines31/marketingskills (`skills/marketing-loops`)
- Commit: `7868cb9251fad80a73d26e488a5ad5f6c4a9f335` (v2.10.0)
- License: MIT (see `LICENSE`) — Copyright (c) 2025 Corey Haines

Vendored verbatim and mirrored byte-for-byte into `.agents/skills/marketing-loops/`.
...
Its Tier-1 autonomous / Tier-2 human-gated split mirrors this repository's golden
rule 5: money, accounts, ads, personal data, credentials, new OAuth scopes and
enabling a channel's `autopublish` are `HUMAN_APPROVAL` items, whatever a loop
design says.
