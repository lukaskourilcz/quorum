...
const meetingCopy: Record<string, { name: string; title: string }> = {
  ...
  "ms-daily": { name: "marketingShark carousel room", title: "Prepare today's two carousel drafts" },
  "bh-desk": { name: "BOOKSOFHISTORY desk", title: "Choose, research or draft the next book story" },
  "dm-desk": { name: "Door Money story desk", title: "Prepare a bounded, cited recommendation" },
  "dm-growth": { name: "Door Money growth room", title: "Prepare practical owner actions without outreach" },
  "ts-desk": { name: "Tehdejší svět desk", title: "Plan or produce the next Czech and Ukrainian feature" },
