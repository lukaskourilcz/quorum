...
export type PublicMeetingKind = "cu-edition" | "cu-product" | "tt-marketing" | "gv-brief" | "incubator-scan" | "incubator-synthesis" | "mma-intake" | "mma-analysis" | "mag-editorial" | "mag-desk" | "studio";
...
export function parsePublicMeetingRecord(value: unknown): PublicMeetingRecord | null {
  ...
  const kind = record.kind === "cu-edition" || record.kind === "cu-product" || record.kind === "tt-marketing" || record.kind === "gv-brief" || record.kind === "incubator-scan" || record.kind === "incubator-synthesis" || record.kind === "mma-intake" || record.kind === "mma-analysis" || record.kind === "mag-editorial" || record.kind === "mag-desk" || record.kind === "studio" ? record.kind : null;
