...
const mandates: Record<AgentId, string> = {
  ...
  HERALD: "Chooses and takes responsibility for the daily Caught Up story.",
  ...
  SPARK: "Brings one realistic Caught Up product idea to each morning meeting and follows it through the final decision.",
  ...
  RELAY: "Makes sure finished work reaches Caught Up and keeps the daily summary and calendar accurate.",
