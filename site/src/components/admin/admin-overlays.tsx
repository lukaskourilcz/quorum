...
export function AdminDialog({ theme = "dark", classNames, ...props }: AdminDialogProps) {
  return (
    <Dialog
      {...props}
      classNames={{
        root: cn("text-[var(--admin-foreground)]", classNames?.root),
        ...
        eyebrow: cn("font-sans text-[10px] font-semibold tracking-[0.08em] text-[var(--admin-foreground-muted)]", classNames?.eyebrow),
        title: cn("text-[18px] text-[var(--admin-foreground)]", classNames?.title),
        close: cn(
        ...
        footer: cn("border-[var(--admin-border)] px-5 py-3 font-sans text-[10px] text-[var(--admin-foreground-muted)]", classNames?.footer),
      }}
...
export function AdminTooltip({
  ...
  return (
    <Tooltip
      ...
      contentClassName={cn("text-[12px] text-[var(--admin-foreground)]", contentClassName)}
      labelClassName={cn("font-sans text-[10px] font-semibold tracking-[0.08em] text-[var(--admin-foreground-muted)]", labelClassName)}
      scopeAttributes={{ "data-admin": "", "data-admin-theme": theme }}
    />
  );
}
