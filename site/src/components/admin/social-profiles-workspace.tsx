...
export function SocialProfilesWorkspace({ campaignId, profileId, section, snapshot }: { campaignId?: string; profileId?: string; section: SocialProfileSectionId; snapshot: AdminSocialProfilesSnapshot }) {
  return (
    <div data-social-profiles-workspace>
      ...
      {section === "venture-profiles" ? <VentureProfiles profileId={profileId} snapshot={snapshot} /> : section === "amplification-profiles" ? <AmplificationProfiles profileId={profileId} snapshot={snapshot} /> : section === "campaigns" ? <Campaigns campaignId={campaignId} snapshot={snapshot} /> : section === "network" ? <Network snapshot={snapshot} /> : section === "providers" ? <Providers snapshot={snapshot} /> : section === "content-runway" ? <ContentRunway profileId={profileId} snapshot={snapshot} /> : section === "results" ? <Results snapshot={snapshot} /> : <ActivitySetup snapshot={snapshot} />}
