 ...
 * panel is an overlay laid over the plan, leaving 14 units of the drawing visible on every side
 * so it reads as the room opened rather than as a new screen. Below it, the same body is an
 * ordinary expandable block in the page's flow, because nothing on a phone is intercepted.
 *
...
/** Each column of a panel body rises once, staggered, and rests at its true value. */
