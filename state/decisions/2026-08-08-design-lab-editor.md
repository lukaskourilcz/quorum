...
- [ ] DL-01 — Persistence tells the truth: create path, visible save states (contract §DL-01)
...
- [ ] DL-11 — Export: per-slide PNG and whole-deck ZIP with captions (contract §DL-11)
