...
REACH prepares Czech captions for Instagram and Threads inside the
...
- Both variants keep the article facts and use platform-native Czech wording.
- Both variants reference only a live Carousel Studio template id, semantic version
  and bounded Czech content payload. FRAME renders the brand skin to PNG at
